...
function NavbarInstitucional() {
  ...
  // const [seleccionada, setSeleccionada] = useState(false); <--- Eliminado: el estado no se usa para renderizar

  const manejarClick = (rutaDestino) => {
    // setSeleccionada(true); <--- Eliminado: ya que el estado no se usa, la función tampoco es necesaria
    setTimeout(() => {
