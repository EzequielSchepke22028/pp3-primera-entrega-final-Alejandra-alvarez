...
function Donde() {
  return (
    <div className="IFTS-info">
      ...
      <p>IFTS 9.</p>
      <p>
        Desde 1983, formando técnicos de nivel superior con las competencias
        necesarias para responder a las demandas sociales y productivas.
      </p>

      <h3>Misión:</h3>
      <p>
        Formar técnicos con capacidades adecuadas a las demandas sociales y
        productivas.
      </p>
      ...
      >
        <p>
          <strong>Mapa temporal - Funcionalidad de Google Maps en desarrollo</strong>
        </p>
      ...
      <h3>ITFS 04 - Murguiondo 2126</h3>
      <iframe
        src="https://maps.google.com/maps?q=Murguiondo%202126&t=&z=15&ie=UTF8&iwloc=&output=embed"
        width="100%"
        height="300"
        style={{ border: 0 }}
        allowFullScreen=""
        ...
        title="Mapa ITFS 04 Murguiondo 2126"
      ></iframe>
    </div>
  );
}
